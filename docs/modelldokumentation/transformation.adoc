...
| todo m| Kennung_Bund
| todo m| Beschreibung
| todo m| hat_Realersatzpflicht
| todo m| Rodungsflaeche_def
| todo m| Rodungsflaeche_temp
| todo m| Rodungsflaeche_histo
| todo m| Realersatzflaeche
| todo m| Verzichtsflaeche
| todo m| Massnahmeflaeche_total
| todo m| EA_Flaeche_total
| todo m| EA_Flaeche_gebietsfremd
| todo m| Massnahmenbeschreibung
| todo m| Massnahmeflaeche_Wald
| todo m| Massnahmeflaeche_Nichtwald
| todo m| hat_Massnahmenpool
| todo m| Massnahmenbemerkung
| todo m| Rodungszweckbemerkung
| todo m| Rodungsfrist
