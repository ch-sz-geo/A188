...
* Sachdaten
** **RodungenSZ_Datenbank.accdb** mit Abgabedatum vom 26. Februar 2026
* Geodaten
** **Rodungen&Ersatz.gpkg** mit Abgabedatum vom 26. Februar 2026 (weiter unten als "[Geo-1]" bezeichnet)
...
| `+RodungenSZ.Datum Rodung ausgeführt+` m| todo: Name bestimmen
...
| `+RodungenSZ.Datum Ersatzaufforstung ausgeführt+` m| todo: Name bestimmen
| `+NULL+` m| hat_Finanzausgleich
...
| `+NULL+` m| Flaeche_Fruehere_Rodung15Jahre
...
| `+NULL+` m| Flaeche_Ersatz_MassnahmenNL
| `+NULL+` m| MassnahmeNL_Typ
| `+NULL+` m| MassnahmenNL_Beschreibung
| `+NULL+` m| FlaecheMassnahmeNL_ImWaldareal
| `+NULL+` m| FlaecheMassnahmeNL_AusserhalbWaldareal
| `+NULL+` m| MassnahmeNL_Pool
| `+NULL+` m| Massnahme_WeitereBemerkungen
...
| `+NULL+` m| Verfuegung_URL
| `+NULL+` m| Weitere_Referenzen
