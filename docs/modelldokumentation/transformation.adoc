...
* Geodaten
** **Nachteilige_Nutzungen_KTSZ - Kopie.gpkg** mit Stand vom 11.12.2024
** **Rodungen&Ersatz - Kopie.gpkg** mit Stand vom 26.01.2026

==== Details zum Attributmapping
Die detaillierte Beschreibung der Überführung der Quellattribute zu ihren Zielattributen entnehme man dem FME-Workpsace, welches im Themenverzeichnis abgelget ist.
