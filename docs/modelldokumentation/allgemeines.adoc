...
Die Daten eines Rodungsgeschäfts werden erst mit Rechtskraft des Rodungsgesuch erfasst; also nach Ablauf der Beschwerderist der entsprechenden Rodungsbewilligung. Damit entfallen Informationen zum Verfahren.
