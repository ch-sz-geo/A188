...
* *__Rodungen und Rodungsersatz__.* +

Die für das Thema zuständige Stelle erfasst die Rodungsbewilligungen nach Ablauf der Beschwerdefrist. Damit sind alle Rodungsbewilligungen in Kraft. Damit wird auch auf die Erfassung verfahrensrelevanter Informationen verzichtet. Dies im Unterschied zum Thema "Waldfeststellungen" (A057).
